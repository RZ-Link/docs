...
服务器1创建硬盘，启动虚拟机1，设置静态IP为10.0.0.10，子网掩码为255.255.255.0
```shell
...
服务器1创建硬盘，启动虚拟机2，设置静态IP为10.0.0.20，子网掩码为255.255.255.0
```shell
...
服务器2创建硬盘，启动虚拟机3，设置静态IP为10.0.0.30，子网掩码为255.255.255.0
```shell
